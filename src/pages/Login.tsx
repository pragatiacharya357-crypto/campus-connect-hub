  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 gradient-hero relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute bottom-32 left-10 w-40 h-40 rounded-full bg-accent/20 blur-3xl"
      />

      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ type: "spring" }} className="w-full max-w-md relative z-10">
        <motion.div
        ...
        >
          ...
          <p className="text-primary-foreground/60 text-sm tracking-wide">Your Campus. Your Voice.</p>
        </motion.div>

        <Card className="border-0 shadow-2xl backdrop-blur-sm bg-card/95">
          <CardHeader className="text-center pb-2">
            <CardTitle className="font-display text-xl">Welcome Back</CardTitle>
            <CardDescription>Sign in to your UniBuzz account</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="password" type="password" placeholder="Enter your password" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 rounded-xl" required />
                </div>
              </div>
              ...
              <motion.div whileTap={{ scale: 0.97 }}>
                <Button type="submit" disabled={loading} className="w-full gradient-glow text-primary-foreground h-11 shadow-lg shadow-primary/20">
            ...
            <Button type="button" variant="outline" className="w-full h-11 rounded-xl" onClick={handleGoogleSignIn}>
